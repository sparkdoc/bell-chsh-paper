...
modest measurement dependence suffices is known, and the four-state value
coincides, under the change of variable $\ell=\tfrac14-F$, with the
measurement-dependent-locality bound of P\"utz \emph{et al.}; the
contribution is the exact, certified treatment in the total-variation metric
for all $N$ and all source distributions, together with the observation that
the cost can be paid without leaving a trace in the observable marginals.
\end{abstract}
